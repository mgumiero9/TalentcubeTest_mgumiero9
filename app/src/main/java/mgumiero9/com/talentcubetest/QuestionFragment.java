...
public class QuestionFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_selfie1, container, false);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mTextureView = (AutoFitTextureView) view.findViewById(R.id.texture7);
    }

    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mFile = new File(getActivity().getExternalFilesDir(null), "selfie.dat");
    }
    ...
    /**
     * Opens the camera specified by {@link QuestionFragment#mCameraId}.
     */
        ...
        try {
            ...
            CameraCaptureSession.CaptureCallback CaptureCallback
                ...
                public void onCaptureCompleted(@NonNull CameraCaptureSession session,
                    ...
                    Log.e(TAG, "File Saved::--->" + mFile.getAbsolutePath());
                    unlockFocus();
                     ...
                     *
                     * */
/*                    // Opening CNH2 fragment
                    Selfie2FragmentGood Selfie2FragmentGood = new Selfie2FragmentGood();
                    getActivity().getFragmentManager().beginTransaction()
                            .replace(R.id.container, Selfie2FragmentGood)
                            .addToBackStack(null)
                            .commit();*/
                }
            };
